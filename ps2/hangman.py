...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the
    ...
    while True:
        ...
        # feedback to print based on guess made
        message = ''
        ...
        if not str.isalpha(guess):
            if warnings_left > 0:
                warnings_left -= 1
                message = f'Oops! That is not a valid letter. You now have {warnings_left} warnings left: '
            else:
                guesses_left -= 1
        ...
        # valid letter
            ...
            if guess in letters_guessed:
                if warnings_left > 0:
                    warnings_left -= 1
                    message = f'Oops! You\'ve already guessed that letter. You now have {warnings_left} warnings left: '
                else:
                    guesses_left -= 1
...
def match_with_gaps(my_word, other_word):
    ...
    for i in range(len(other_word)):
        my_letter = my_word_no_spaces[i]
        other_letter = other_word[i]

        # hidden letter equals the letter that has already been guessed
        if my_letter == '_' and other_letter in my_word_no_spaces:
            return False

        # different letters at the same position
